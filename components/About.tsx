export default function About() {
  return (
    <section id="about" aria-labelledby="about-heading" className="mx-auto max-w-7xl px-4 py-16">
      <h2 id="about-heading" className="text-3xl md:text-4xl font-bold">About</h2>
